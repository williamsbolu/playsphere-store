...
function Header() {
  ...
  const isCheckingOut = location.pathname === '/checkout';
  ...
  return (
    <>
      ...
      <header
        className={`${!isCheckingOut && 'sticky'} top-0 z-20 bg-white shadow-sm`}
      >
        <div
          className={`app-container flex h-[80px] items-center ${!isCheckingOut ? 'justify-between' : 'justify-center'} `}
        >
          <Link to="/">
                      ...
                      <ul>
                        ...
                        <li>
                          <Link
                            ...
                            className="flex items-center gap-[10px] whitespace-nowrap py-[10px] pl-3 text-[13px] font-semibold hover:bg-primary/5 hover:text-primary"
                          >
                            <IoIosHeartEmpty className="h-6 w-6 text-black" />{' '}
                            My Saved Items
                          </Link>
                        </li>
                        <li>
                          <Link
                            ...
                            className="flex items-center gap-[10px] whitespace-nowrap py-[10px] pl-3 text-[13px] font-semibold hover:bg-primary/5 hover:text-primary"
                          >
                            <FaRegAddressCard className="h-5 w-5 text-black" />{' '}
                            My Addresses
                          </Link>
                        </li>
                        <li>
